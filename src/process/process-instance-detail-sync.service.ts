...
export class ProcessInstanceDetailSyncService implements OnModuleInit {
  ...
  private async handleUpsert(processInstanceDetail: any) {
    try {
  ...
  private mapToProcessInstanceDetailEntity(processInstanceDetail: any): ProcessInstanceDetailSyncEntity {
