...
@Module({
  imports: [
    MongooseModule.forFeature([{ name: "payment", schema: PaymentSchema },{ name: "salesDocument", schema: SalesChanelSchema },{ name: "coinTransaction", schema: CoinTransactionSchema },{ name: "systemConfiguration", schema: SystemConfigurationSchema },]),
    SharedModule,
    AuthModule,
    InvoiceModule,
    HelperModule,
